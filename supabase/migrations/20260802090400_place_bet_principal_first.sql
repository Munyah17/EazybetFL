-- Same as the agent-commission version of fn_place_bet
-- (20260729120100_agent_role.sql), except stakes are now spent from
-- combined principal_balance + balance (principal first) via
-- fn_wallet_debit_spend, instead of balance only.
